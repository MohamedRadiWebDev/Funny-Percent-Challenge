...
const POPUP_CONFIGS: Record<number, PopupConfig> = {
  ...
  2: {
    ...
    bgFrom: "#fdf4ff",
    bgTo: "#f0abfc",
    title: "لسه شايفاني مستفز",
    subtitle: "الدنيا بدأت تهدى شوية 👀",
    btnLabel: "كملي تقييم 😌",
  },
  3: {
    emoji: "😌",
    bgFrom: "#fff7ed",
    bgTo: "#fed7aa",
    title: "فيه تحسن ولا ايه؟",
    subtitle: "مقبول بالعافية 😅",
