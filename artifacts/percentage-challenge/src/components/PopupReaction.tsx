...
const POPUP_CONFIGS: Record<number, PopupConfig> = {
  1: {
    ...
    bgFrom: "#fce7f3",
    bgTo: "#f9a8d4",
    title: "لسه واخد موقف محترم 😭",
    subtitle: "واضح إن الصلح محتاج شوية وقت كمان",
    btnLabel: "نجرب تاني 😅",
  },
  2: {
    emoji: "🤦",
    bgFrom: "#fdf4ff",
    bgTo: "#f0abfc",
    title: "الدنيا بدأت تهدى شوية",
    subtitle: "بس واضح إني لسه تحت المراقبة 👀",
    btnLabel: "كملي تقييم 😌",
  },
  3: {
    emoji: "😌",
    bgFrom: "#fff7ed",
    bgTo: "#fed7aa",
    title: "المنطقة الرمادية",
    subtitle: "لا متسامح بالكامل ولا متعكنن بالكامل 😅",
    btnLabel: "لسه قدامنا شوية 🚀",
  },
  4: {
    emoji: "🥹",
    bgFrom: "#fef3c7",
    bgTo: "#fde68a",
    title: "الصلح قرب أهو",
    subtitle: "واضح إنك بدأتي تفكي الحظر النفسي 😭❤️",
    btnLabel: "قربنا نوصل 🔥",
  },
  5: {
    emoji: "😍",
    bgFrom: "#ecfdf5",
    bgTo: "#a7f3d0",
    title: "يا ساتر... قربنا أوي",
    subtitle: "متأكدة إنك مش عايزة تدي الـ100؟ 😌",
    btnLabel: "آخر دفعة 😍",
  },
  6: {
    emoji: "🥳",
    ...
    bgTo: "#c4b5fd",
    title: "مبروك 🎉",
    subtitle: "تم اعتماد الصلح رسميًا وإلغاء كل الخناقات السابقة 😂❤️",
    btnLabel: "نعيدها تاني 🔄",
  },
};
